...
# load data
wx<-read.csv("weather_st_paul/data/wx_stpaul_19871101_20210430.csv", header=TRUE)
summary(wx)
...
ws_pct5th_tmin<-quantile(ws_wx$TMIN, 0.05, na.rm=T) # outputs 5th percentile TMIN of all winter months 1993-2020: -14.9 deg C
...
sp_pct5th_tmin<-quantile(sp_wx$TMIN, 0.05, na.rm=T) # outputs 5th percentile TMIN of all winter months 1993-2021: -11.1 
# Create indicator variable for winter extreme low temp days
...
ws_pct95th_wind<-quantile(ws_wx$AWND, 0.95, na.rm=T) # outputs 95th percentile average daily wind speed for winter-spring 1993-2021: 13.6 km/h   
...
w_pct95th_wind<-quantile(w_wx$AWND, 0.95, na.rm=T) # outputs 95th percentile average daily wind speed for winter 1993-2021: 13.8 km/h    
...
sp_pct95th_wind<-quantile(sp_wx$AWND, 0.95, na.rm=T) # 95th percentile average daily wind speed for spring 1993-2021: 12 km/h   
...
write.csv(wx_st_paul_1993_2019, "weather_st_paul/output/wx_st_paul_1993_2020.csv")
