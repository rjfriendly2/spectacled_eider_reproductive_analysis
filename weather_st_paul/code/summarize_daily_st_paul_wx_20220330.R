...
# 11. Save data frame as csv "wx_st_paul_1993_2020.csv"

# got packages
library(tidyverse)

# load data
wx<-read.csv("weather_st_paul/data/wx_stpaul_19871201_20220301.csv", header=TRUE)
summary(wx)
...
w_pct5th_tmin<-quantile(w_wx$TMIN, 0.05, na.rm=T) # outputs 5th percentile TMIN of all winter months 1993-2021 
...
sp_pct5th_tmin<-quantile(sp_wx$TMIN, 0.05, na.rm=T) # outputs 5th percentile TMIN of all winter months 1993-2021 
# Create indicator variable for winter extreme low temp days
...
wx_st_paul_1993_2020<-merge(ws_extreme_temp,
                            w_extreme_temp[2],
                            sp_extreme_temp[2],
                            winter_temp[2],
                            spring_temp[2],
